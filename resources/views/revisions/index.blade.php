<x-app-layout>
    ...
    <div class="py-6 space-y-6">
        ...
        @include('revisions.partials.list', ['revisions' => $revisionsToday, 'emptyMessage' => 'Nenhuma revisão para hoje. Bom trabalho!'])       </div>

        <div id="content-overdue" class="tab-content hidden">
       @include('revisions.partials.list', ['revisions' => $revisionsOverdue, 'emptyMessage' => 'Nenhuma revisão atrasada. Você está em dia!'])        </div>

        <div id="content-completed" class="tab-content hidden">
          @include('revisions.partials.list', ['revisions' => $revisionsCompleted, 'isCompleted' => true, 'emptyMessage' => 'Nenhuma revisão concluída ainda.'])   </div>
    </div>
